...
unreliable, high-interference, and disaster-prone networks. The shared identity — the bootstrap
seeds, trust roots, spore-signing keys, and certified nodes — is the part of the project that the
community stewards in common and puts its shared trust signatures on. It would betray the whole
purpose of the project to let that specific, trusted identity be turned against the very people it
is meant to protect.
