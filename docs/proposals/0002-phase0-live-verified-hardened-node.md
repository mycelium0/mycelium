...
| `coordinator` (fleet registry / rerouting) | Not built here | deferred | none | Activates in a later RP (Phase 3); inert in Phase 0. |
...
- **Multi-node / fleet** — a second node, fleet registry, coordinator, cross-node config
