...
**Option 3.** Adopt **Advisory Network Awareness** as a **cross-cutting Measurement & Immunity increment** — explicitly *advisory federation*, the deliberate **opposite** of Phase 3's actuating coordinator — and build it as a **projection of the existing weather/immunity contracts**, never a new per-node shape. It is **not** a phase; it rides Phase-2 self-healing and dissolves into the Phase 4–5 mesh.
