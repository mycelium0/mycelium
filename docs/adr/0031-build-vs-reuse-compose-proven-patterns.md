...
**Anastomosis security requirements** (operator, 2026-06-17 — amend [ADR-0029](0029-community-federated-ingress.md), to be specified for Phase 4–5):
...
- Reuse stays **behind** Mycelium's own transports and **inside** the scoped→federated→open-mesh trajectory; nothing here pulls a Phase-5/6 mechanism into early runtime (the inert-interface rule holds).
