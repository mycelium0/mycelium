...
- **Status:** draft
- **Horizon:** primary Phase 3–4 (with inert Phase 0–2 interfaces; the inert fungi/advisory seam is Phase-2 groundwork that goes live in Phase 3) — deferred pieces in Phase 6 (trust-gradient routing), Phase 7 (carrier-bridged island merge) and Phase 8 (autonomous cord promotion) — see [../ROADMAP.md](../ROADMAP.md)
...
- **Carrier-bridged island merge** (two separated fragments reconciling registries/topology over any
  ...
  connected mesh* is Phase 4 (maturing through Phase 6); reconciling *across* a partition boundary over a carrier is Phase 7.
