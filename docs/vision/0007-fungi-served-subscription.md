...
- **Horizon:** Distribution / discovery track. Today: inert schema only (Phase 0–2). Coordinator-assisted
  distribution is Phase 3; DHT/gossip + invite/reputation is Phase 4; trust-gradient hand-out is Phase 5.
...
- **Related:** [0003-node-interaction-and-distributed-awareness.md](0003-node-interaction-and-distributed-awareness.md)
  ...
  out-of-band hand-off), [../ROADMAP.md](../ROADMAP.md) (Phase 1 matured endpoint; Phase 3–5 distribution).
...
## Phase discipline (this is mostly Phase 3–5; almost nothing is built now)
...
- **Phase 5 — trust-gradient hand-out.** Per-user slice quality follows the trust gradient.
